...
import br.com.feluz.jpa.dao.CostumerDB2DAO;
...
public class CostumerDAOTest {
    ...
    private ICostumerDAO costumerDB2DAO;
    private Costumer costumer;


    public CostumerDAOTest() {
        costumerDAO = new CostumerDAO();
        costumerDB2DAO = new CostumerDB2DAO();
    }
    ...
    public void save() {
        ...
        costumer.setId(null);
        costumer.setCpf(11122233366L);
        Costumer isRegistered2 = costumerDB2DAO.register(costumer);
        Assert.assertNotNull(isRegistered2);
        Assert.assertEquals(isRegistered2.getId(), costumer.getId());
    }
